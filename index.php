...
$pageTitle = SITE_NAME . ' - Tim kiem bat dong san';
...
<section class="hero">
  <div class="hero-inner">
    <div>
      <span class="hero-eyebrow">Tim kiem khong gian ly tuong cua ban</span>
      <h1>Tim ngoi nha<br>mo uoc hom nay</h1>
      <p>Kham pha chung cu, nha rieng, van phong va mat bang kinh doanh khap Viet Nam - mua ban hoac cho thue, ket noi truc tiep voi nhan vien phu trach.</p>
      <a href="<?= BASE_URL ?>/properties.php" class="btn btn-primary">Xem bat dong san &rarr;</a>
    </div>
...
<div class="container">
  <form class="search-box" action="<?= BASE_URL ?>/properties.php" method="get">
    <div class="search-tabs">
      ...
      <button type="button" data-value="rent">Thue</button>
    </div>
    ...
    <div class="search-fields">
      ...
      <div class="search-field">
        ...
        <select name="price_range">
          ...
          <option value="0-1000000000">Duoi 1 ty</option>
          <option value="1000000000-3000000000">1 - 3 ty</option>
          <option value="3000000000-6000000000">3 - 6 ty</option>
          <option value="6000000000-">Tren 6 ty</option>
        </select>
      </div>
      <div class="search-field">
        ...
        <select name="bedrooms">
          ...
          <option value="1">1+ phong</option>
          <option value="2">2+ phong</option>
          <option value="3">3+ phong</option>
          <option value="4">4+ phong</option>
        </select>
      </div>
...
<section class="section">
  <div class="container">
    <div class="section-head">
      <div>
        <span class="eyebrow">Chon theo loai hinh</span>
        <h2>Tim bat dong san phu hop<br>voi <span class="accent">phong cach cua ban</span></h2>
      </div>
      <a href="<?= BASE_URL ?>/properties.php" class="btn btn-outline">Xem tat ca &rarr;</a>
    </div>
    <div class="type-grid">
      <?php foreach ($types as $t): ?>
        <a class="type-card" href="<?= BASE_URL ?>/properties.php?property_type=<?= e($t['slug']) ?>">
          ...
          <div class="type-card-body">
            <h3><?= e($t['name']) ?></h3>
            <p><?= (int)($typeCounts[$t['id']] ?? 0) ?> bat dong san</p>
...
<section class="section" style="background:var(--bg-soft)">
  <div class="container">
    <div class="section-head">
      <div>
        <span class="eyebrow">Bat dong san noi bat</span>
        <h2>Lua chon <span class="accent">danh rieng cho ban</span></h2>
      </div>
      <a href="<?= BASE_URL ?>/properties.php" class="btn btn-outline">Xem tat ca &rarr;</a>
    </div>
    <?php if (empty($featured)): ?>
      <p class="empty-state">Chua co bat dong san nao duoc dang.</p>
    <?php else: ?>
...
<section class="stats-bar">
  <div class="container stats-grid">
    <div>
      ...
      <strong>1200+</strong><span>Khach hang hai long</span>
    </div>
    <div>
      ...
      <strong><?= $totalProperties ?>+</strong><span>Bat dong san dang tin</span>
    </div>
    <div>
      ...
      <strong><?= $totalEmployees ?>+</strong><span>Nhan vien tu van</span>
    </div>
    <div>
      ...
      <strong>98%</strong><span>Khach hang hai long</span>
    </div>
  </div>
</section>
