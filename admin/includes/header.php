 ...
 */
$pageTitle = $pageTitle ?? 'Bảng điều khiển';
$activeNav = $activeNav ?? '';
$user = currentUser();
?>
<!DOCTYPE html>
...
<div class="admin-wrap">
  <aside class="admin-sidebar">
    ...
    <nav class="admin-nav">
      ...
      <a href="<?= BASE_URL ?>/admin/amenities.php" class="<?= $activeNav === 'amenities' ? 'active' : '' ?>">
      ...
      <a href="<?= BASE_URL ?>/admin/properties.php" class="<?= $activeNav === 'properties' ? 'active' : '' ?>">
        ...
        <?= isAdmin() ? 'Bất động sản' : 'Bất động sản của tôi' ?>
      </a>
  ...
  <div class="admin-main">
    <header class="admin-topbar">
      ...
      <div class="admin-user">
        <span class="role-badge role-<?= e($user['role']) ?>"><?= $user['role'] === 'admin' ? 'Quản trị viên' : 'Nhân viên' ?></span>
